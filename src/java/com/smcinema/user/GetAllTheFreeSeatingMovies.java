...
public class GetAllTheFreeSeatingMovies extends HttpServlet {
    Connection con;
    PreparedStatement pstmt;
    ResultSet rs;
    JSONObject JSONFreeSeating_movies = new JSONObject();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            pstmt.setString(1, "Free Seating");
            ...
            JSONFreeSeating_movies.put("FREESEATING_MOVIES", jsonArray);
            response.getWriter().write(JSONFreeSeating_movies.toString());
        } catch (SQLException ex) {
            Logger.getLogger(GetAllTheFreeSeatingMovies.class.getName()).log(Level.SEVERE, null, ex);
