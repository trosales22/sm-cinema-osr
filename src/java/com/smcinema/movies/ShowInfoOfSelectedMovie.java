...
public class ShowInfoOfSelectedMovie extends HttpServlet {
    Connection con;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            while(rs.next()){
                ...
                request.getSession().setAttribute("MOVIE_BRANCHNAME", rs.getString("MOVIE_BRANCHES"));
                ...
                response.sendRedirect(request.getContextPath() + "/pages/USER/home.jsp?movie_id=" + movieID + "#reserveTickets"); 
            }
            con.close();
        } catch (SQLException ex) {
            Logger.getLogger(ShowInfoOfSelectedMovie.class.getName()).log(Level.SEVERE, null, ex);
